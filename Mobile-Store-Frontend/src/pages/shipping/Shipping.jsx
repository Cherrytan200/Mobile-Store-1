...
const Shipping = () => {
    ...
    // Fake data for the iPhone 14 Pro Max
    const fakeData = {
        ...
        price: 989.1, // Price after discount
        shipping_fee: 20,
        items: 1,
    };
                            ...
                            <div className='pl-3 md-lg:pl-0 md-lg:mt-5'>
                                <div className='bg-white p-3 text-slate-600 flex flex-col gap-3'>
                                    ...
                                    <div className='flex justify-between items-center'>
                                        ...
                                        <span>${fakeData.shipping_fee} </span>
                                    </div>
                                    <div className='flex justify-between items-center'>
                                        <span>Total Payment </span>
                                        <span>${fakeData.price + fakeData.shipping_fee} </span>
                                    </div>
                                    <div className='flex justify-between items-center'>
                                        <span>Total</span>
                                        <span className='text-lg text-[#059473]'>${fakeData.price + fakeData.shipping_fee} </span>
                                    </div>
                                    <Link to='/payment'>
                                    <button  disabled={!res} className={`px-5 py-[6px] rounded-sm hover:shadow-red-500/50 hover:shadow-lg ${res ? 'bg-red-500' : 'bg-red-300'}  text-sm text-white uppercase`}>
                                        Place Order
                                    </button>
                                    </Link>
                                </div>
